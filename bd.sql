/*
* Данная бд отображает приблизительную бд одного из форумов, https://www.harrypotter.com.ua. Форум достаточно большой и активный, 
* создан по миру Гарри Поттера. Здесь я частично отобразила одну из важнейших структур форума - школу Хогвартс (директором которой я работала 
* на протяжении 2 лет): преподаватели, предметы и лекции. Так же вкользь отображены модераторы и прочие должности. 
* И, конечно же, есть маг.информация юзеров, заклинания и их применения друг на друга. 
*/
